            ...
            <div className="col-lg-8 offset-lg-2">
                <div className="invoice-content">
                            ...
                            <div className="col-md-6">
                                <div className="invoice-info">
                                    ...
                                    <p className="invoice-details invoice-details-two">
                                        Dr. {data?.appointment?.doctor?.firstName ? `${data?.appointment?.doctor?.firstName} ${data?.appointment?.doctor?.lastName}`: ' Of SevaCare India'} <br />
                                        {data?.appointment?.doctor?.address ? data?.appointment?.doctor?.address : "Mumbai, Dhaka ,BD,3214"}, {data?.appointment?.doctor?.city && data?.appointment?.doctor?.city},<br />
                    ...
                    <div className="other-info">
                        ...
                        <p className="text-muted mb-0">Please note that the consultation fee is non-refundable once the appointment is confirmed. Please arrive 15 minutes prior to your scheduled time. If you need to reschedule, kindly manage your booking at least 24 hours in advance through the SevaCare dashboard or contact our support team.</p>
                    </div>
