...
const DoctorBooking = () => {
    ...
    useEffect(() => {
        ...
        const isConfirmInputEmpty = selectValue.paymentType === 'cash' 
            ? !isCheck 
            : (!nameOnCard || !cardNumber || !expiredMonth || !cardExpiredYear || !cvv || !isCheck);
    ...
    const steps = [
        ...
        },
        {
            ...
            content: <PersonalInformation handleChange={handleChange} selectValue={selectValue} setPatientId={setPatientId} setSelectValue={setSelectValue} />
        },
        {
            title: 'Payment',
