				...
				<div className="row align-items-center g-4 g-lg-5">
					...
					<div className="col-lg-4">
						<div className="service-content-card">
							...
							<h2>Quality care, close to you in India</h2>
							<p>
								SevaCare India brings together experienced specialists, modern diagnostic equipment, and a focus on compassionate patient care. 
								We offer specialized treatments, wellness programs, and 24/7 telemedicine tailored to your needs.
							</p>
