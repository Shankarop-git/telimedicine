        ...
        <div id="topbar" className="d-flex align-items-center fixed-top">
            <div className="container d-flex justify-content-between">
                <div className="contact-info d-flex align-items-center">
                    <FaEnvelope className='contact-icon'/> <a href="mailto:ujjalzaman@example.com">contact@sevacare.in</a>
                    <FaPhoneAlt className='contact-icon'/> <a href="tel:+91 22 4930 0000">+91 22 4930 0000</a> 
                </div>
