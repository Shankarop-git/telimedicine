						...
						<div className="col-12 col-sm-6 col-lg-3">
							<div className="footer-widget footer-contact">
								...
								<div className="footer-contact__item">
									...
									<p>Floor 5, Solitaire Corporate Park,<br />Andheri East, Mumbai, Maharashtra 400093</p>
								</div>
								<div className="footer-contact__item">
									<FaPhoneAlt className="footer-contact__icon" />
									<p><a href="tel:+91 22 4930 0000">+91 22 4930 0000</a></p>
								</div>
								<div className="footer-contact__item">
									<FaEnvelope className="footer-contact__icon" />
									<p><a href="mailto:contact@sevacare.in">contact@sevacare.in</a></p>
								</div>
							</div>
						</div>
					</div>
